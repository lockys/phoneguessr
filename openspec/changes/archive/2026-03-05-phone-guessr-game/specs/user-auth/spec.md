...
The system SHALL allow users to play the daily puzzle without authentication. Anonymous users SHALL have full gameplay functionality but no leaderboard recording.
