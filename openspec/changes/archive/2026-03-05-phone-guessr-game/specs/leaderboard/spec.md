...
The system SHALL allow both authenticated and anonymous users to view leaderboards. Only authenticated users' scores appear on leaderboards.

#### Scenario: Anonymous user views leaderboard
- **WHEN** an anonymous user views any leaderboard
